const formData={
    ...
    formFields:[
        ...
        {id:4, name:"address", label:"address", placeHolder:"Enter address!", type:"text", required:false },
        ...
        // {id:4, name:"gender", label:"Gender", placeHolder:"Enter gender!", type:"select", required:false ,options:[{id:1, value:"male", label:"Male"},{id:2, value:"female", label:"Female"},{id:3, value:"other", label:"Other"}] },
        // {id:5, name:"nationality", label:"Nationality", placeHolder:"Enter nationality!", type:"radio", required:false, options:[{id:1, value:"indian", label:"Indian"},{id:2, value:"other", label:"Other"}] },
        ...
        {id:2, name:"email", label:"Email", placeHolder:"Enter email!", type:"email", required:true },
        {id:3, name:"contact", label:"Contact No.", placeHolder:"Enter contact no!", type:"tel", required:true, pattern:"[0-9]{3}-[0-9]{2}-[0-9]{3}" },
        {id:4, name:"query", label:"Query", placeHolder:"Enter query!", type:"text", required:false },
        {id:5, name:"city", label:"City", placeHolder:"Enter city!", type:"text", required:false },
        {id:6, name:"zip", label:"Area Pincode", placeHolder:"Enter Pincode!", type:"text", required:false },
        {id:3, name:"password", label:"Password", placeHolder:"Enter password!", type:"password", required:false },
