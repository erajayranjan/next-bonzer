  ...
  return (
    ...
    <div className="grid lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Link href={"/courses"}  className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900" >
